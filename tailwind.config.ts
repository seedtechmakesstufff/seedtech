...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        display: ["4.5rem", { lineHeight: "1.05", letterSpacing: "0.04em", fontWeight: "400" }],
        title: ["3.5rem", { lineHeight: "1.1", letterSpacing: "0.03em", fontWeight: "400" }],
        "heading-lg": ["2.75rem", { lineHeight: "1.15", letterSpacing: "0.03em", fontWeight: "400" }],
        heading: ["2.25rem", { lineHeight: "1.2", letterSpacing: "0.02em", fontWeight: "400" }],
        subheading: ["1.5rem", { lineHeight: "1.35", letterSpacing: "0.01em", fontWeight: "400" }],
        "card-title": ["1.125rem", { lineHeight: "1.4", letterSpacing: "0.01em", fontWeight: "400" }],
        "body-lg": ["1.125rem", { lineHeight: "1.65", fontWeight: "400" }],
        body: ["1rem", { lineHeight: "1.6", fontWeight: "400" }],
        "body-sm": ["0.875rem", { lineHeight: "1.55", fontWeight: "400" }],
        eyebrow: ["0.75rem", { lineHeight: "1.5", letterSpacing: "0.08em", fontWeight: "600" }],
        "stat-number": ["3.5rem", { lineHeight: "1.1", letterSpacing: "0.03em", fontWeight: "400" }],
        "step-number": ["2.5rem", { lineHeight: "1.15", letterSpacing: "0.02em", fontWeight: "400" }],
      },
