  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        "heading-lg": ["2.75rem", { lineHeight: "1.15", letterSpacing: "-0.02em", fontWeight: "700" }],
        heading: ["2.25rem", { lineHeight: "1.2", letterSpacing: "-0.01em", fontWeight: "700" }],
        subheading: ["1.5rem", { lineHeight: "1.35", letterSpacing: "-0.01em", fontWeight: "600" }],
        ...
        "stat-number": ["3.5rem", { lineHeight: "1.1", fontWeight: "700" }],
        "step-number": ["2.5rem", { lineHeight: "1.15", fontWeight: "700" }],
      },
