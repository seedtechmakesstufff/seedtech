          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              {["X", "Li", "Gh"].map((icon) => (
                <div
                  key={icon}
                  className="w-10 h-10 rounded-lg bg-white/[0.04] border border-white/[0.06] flex items-center justify-center text-white/50 hover:text-white hover:bg-white/[0.08] transition-all cursor-pointer text-xs font-medium"
                >
                  {icon}
                </div>
              ))}
